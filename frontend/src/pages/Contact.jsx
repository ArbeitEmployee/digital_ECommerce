...
const Contact = () => {
  return (
    ...
    >
      ...
      >
        {/* Page title + breadcrumb - with right padding for asymmetric effect */}
        <div
          style={{
            marginBottom: "24px",
            display: "flex",
        ...
        {/* Map + form - with right padding for asymmetric effect */}
        ...
        {/* Bottom contact info cards - with right padding for asymmetric effect */}
